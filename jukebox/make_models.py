...
MODELS = {
    ...
    'upsample_fast_model': ("vqvae", None, "small_upsampler", None)
}
...
def make_prior(hps, vqvae, device='cuda'):
    ...
    prior_kwargs = dict(input_shape=(hps.n_ctx,), bins=vqvae.l_bins,
                        ...
                        attn_dropout=hps.attn_dropout, emb_dropout=hps.emb_dropout,
                        pos_init=hps.pos_init,  init_scale=hps.init_scale, m_attn=hps.m_attn,
                        checkpoint_res=hps.c_res if hps.train else 0, train=hps.train)
