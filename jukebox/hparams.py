...
small_prior = Hyperparams(
    ...
    init_scale=0.7,
    labels=False,
    #restore_prior="logs/small_vqvae/checkpoint_latest.pth.tar"
)
...
small_upsampler = Hyperparams(
    ...
    cond_dilation_cycle=8,
    cond_c_res=1,
    #restore_prior="/home/laboratorio-procesamiento/Michel/jukebox/logs/small_upsampler/checkpoint_latest.pth.tar"
)
